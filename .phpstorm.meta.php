...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Repositories\Category\CategoryInterface' => \App\Repositories\Category\CategoryRepository::class,
            'App\Repositories\Inventory\InventoryInterface' => \App\Repositories\Inventory\InventoryRepository::class,
            'App\Repositories\OrderItem\OrderItemInterface' => \App\Repositories\OrderItem\OrderItemRepository::class,
            'App\Repositories\Order\OrderInterface' => \App\Repositories\Order\OrderRepository::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links./Applications/XAMPP/xamppfiles/htdocs/13_02_2025/public/storage' => 'string',
            ...
            'l5-swagger.documentations.default.routes.docs' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Applications/XAMPP/xamppfiles/htdocs/13_02_2025/public/storage','l5-swagger.default',
'l5-swagger.documentations.default.api.title','l5-swagger.documentations.default.routes.api','l5-swagger.documentations.default.routes.docs','l5-swagger.documentations.default.paths.use_absolute_path','l5-swagger.documentations.default.paths.swagger_ui_assets_path',
...
'l5-swagger.default.api','l5-swagger.default.docs','l5-swagger.default.asset','l5-swagger.default.oauth2_callback','sanctum.csrf-cookie','products.index','products.show','categories.index',
'categories.products','app.order.show','app.order.orderDetails','app.order.store','app.products.update',
'app.products.destroy','cms.inventory.store','cms.inventory.show','cms.inventory.stockReport','cms.inventory.inventoryRecords',
'cms.category.store','cms.category.update','cms.category.destroy','cms.order.index','cms.order.orderDetails',
'cms.order.store','cms.products.update','cms.products.destroy','cms.products.store','cms.products.update',
'cms.products.destroy','storage.local',);
