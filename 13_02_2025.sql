...
VALUES (1, 'Fruits', '2025-02-28 05:55:27', '2025-02-28 05:55:27'),
...
INSERT INTO `inventory_transactions` (`id`, `product_id`, `quantity`, `type`, `created_at`, `updated_at`)
VALUES (5, 3, 50, 'import', '2025-02-28 05:57:00', '2025-02-28 05:57:00'),
...
VALUES (1, 4, 170.00, 'pending', '2025-02-28 06:01:45', '2025-02-28 06:02:55');
...
VALUES (1, 1, 4, 1, 20.00, '2025-02-28 06:01:45', '2025-02-28 06:02:55'),
...
VALUES (1, 'App\\Models\\User', 4, 'API Token', '89c351a19878e1ee517183ca7dc3689819495833d808a2d5d6c7024c77ec922e',
        '[\"*\"]', '2025-02-28 06:03:50', NULL, '2025-02-28 05:59:10', '2025-02-28 06:03:50'),
       (2, 'App\\Models\\User', 5, 'API Token', 'ec6b8554077844ef8fbe1d135374b45a4b31c49dff09d1a36747bf307a5443a4',
        '[\"*\"]', '2025-02-28 06:04:49', NULL, '2025-02-28 05:59:26', '2025-02-28 06:04:49'),
       (3, 'App\\Models\\User', 3, 'API Token', '951bfc9b9090e6758e0d55d401b8b1dc3de7d31da05978acf79d599fb74ab5d1',
        '[\"*\"]', '2025-02-28 06:05:16', NULL, '2025-02-28 05:59:47', '2025-02-28 06:05:16');
...
VALUES (3, 'Grape', 'Some thing aboud Grape', 150.00, 1, '2025-02-28 05:55:51', '2025-02-28 05:55:51'),
...
INSERT INTO `users` (`id`, `name`, `email`, `role`, `email_verified_at`, `password`, `remember_token`, `created_at`,
                     `updated_at`)
VALUES (3, 'Admin', 'admin01@gmail.com', 'admin', NULL, '$2y$12$drD6bMiRyQzVYsVYM.1yg.9dYcttTlytgvbLl7pTYU09UtGHO54VK',
        NULL, '2025-02-28 05:55:28', '2025-02-28 05:55:28'),
       (4, 'User', 'user01@gmail.com', 'user', NULL, '$2y$12$ZqrF8CHoF6IVNmT0PRmhNOZvOrkQf07NBZRdyZgdEbD6KCGEGXomS',
        NULL, '2025-02-28 05:55:28', '2025-02-28 05:55:28'),
       (5, 'User 02', 'user02@gmail.com', 'user', NULL, '$2y$12$2LjBkGSft69P7IjFRYzHROFKTkSRzAJ1X/rKePvrhb3sURsmETtsK',
        NULL, '2025-02-28 05:58:25', '2025-02-28 05:58:25');
...
ALTER TABLE `cart_items`
  ...
  ADD CONSTRAINT `cart_items_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON
DELETE
CASCADE;
...
ALTER TABLE `order_items`
  ...
  ADD CONSTRAINT `order_items_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON
DELETE
CASCADE;
